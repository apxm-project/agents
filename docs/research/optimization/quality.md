...
> - [Optimization passes](../../optimization/passes.md) -- pass pipeline details (verification-injection, refinement-insertion)
> - [DSPy integration](../dspy-integration.md) -- MIPROv2 quality metrics and assertions
> - [Latency optimization](latency.md) -- the opposite strategy (maximize speed)
> - [Token optimization](tokens.md) -- the cost-focused strategy (minimize tokens)
> - [Production heuristics](../production-heuristics.md) -- multi-layered quality measurement patterns
