...
> **Related documents:**
> - [Optimization overview](../optimization/overview.md) -- how token estimates drive fusion and budget decisions
> - [Optimization passes](../optimization/passes.md) -- passes that consume token estimates (FuseAskOps, DeadContextElimination)
> - [Production heuristics](production-heuristics.md) -- broader survey of production LLM systems
> - [Token optimization](optimization/tokens.md) -- the `--target tokens` strategy that depends on accurate estimates
> - [vLLM integration](../integrations/vllm.md) -- vLLM tokenization approach (model-native)
