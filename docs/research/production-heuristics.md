...
> **Related documents:**
> - [vLLM integration](../integrations/vllm.md) -- APXM's vLLM implementation (prefix caching, KV pinning)
> - [Optimization overview](../optimization/overview.md) -- how these heuristics map to APXM passes
> - [Optimization passes](../optimization/passes.md) -- the pass pipeline these findings inform
> - [Token estimation](token-estimation.md) -- tokenizer research referenced in Section 7
> - [DSPy integration](dspy-integration.md) -- prompt optimization referenced in synthesis
> - [Latency optimization](optimization/latency.md) -- APXM's performance-first strategy
> - [Quality optimization](optimization/quality.md) -- APXM's quality-first strategy
> - [Token optimization](optimization/tokens.md) -- APXM's token-saving strategy
