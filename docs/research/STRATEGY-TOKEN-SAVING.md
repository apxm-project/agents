...
APXM supports five optimization targets (see [08-OPTIMIZATION-TARGETS.md](../strategy/08-OPTIMIZATION-TARGETS.md)):
...
**DSPy** (from Stanford NLP) optimizes prompts algorithmically using training data. See [10-DSPY-INTEGRATION.md](../strategy/10-DSPY-INTEGRATION.md) for full design.
...
|--------------|-----------------|-------------|--------|
| **Dead Context Elimination** | **60-70%** | `dead_context_stress` graph | [RESULTS-WEEK1.md](../benchmarks/RESULTS-WEEK1.md#L71-94) |
...
8. **APXM Cost Analysis**: [COST-ANALYSIS.md](../COST-ANALYSIS.md) — Real dollar savings from optimizations
9. **APXM DSPy Integration**: [10-DSPY-INTEGRATION.md](../strategy/10-DSPY-INTEGRATION.md) — DSPy as compiler pass
10. **APXM Optimization Targets**: [08-OPTIMIZATION-TARGETS.md](../strategy/08-OPTIMIZATION-TARGETS.md) — Latency vs cost vs tokens trade-offs
