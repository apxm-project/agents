...
- [Graph JSON Format](../reference/graph-format.md) -- canonical graph schema, edge types, parameter types
- [Compilation Pipeline](compiler/overview.md) -- four-stage compiler pipeline details
- [Optimization Passes](../optimization/passes.md) -- FuseAskOps, CSE, DCE, and all other MLIR passes
- [Artifact Format](compiler/artifact-format.md) -- `.apxmobj` binary layout
