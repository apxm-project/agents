...
- [Optimization Guide](../optimization/overview.md) — Full compiler optimization details
- [Benchmark Results](../benchmarks/results/2026-04-08.md) — Measuring workflow performance
