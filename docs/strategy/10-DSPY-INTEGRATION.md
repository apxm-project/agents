...
3. Integrate with existing `--target tokens/latency` optimization targets (from doc 08-OPTIMIZATION-TARGETS.md):
...
4. APXM Strategy Docs, "Optimization Targets," *docs/strategy/08-OPTIMIZATION-TARGETS.md*, April 2026.
