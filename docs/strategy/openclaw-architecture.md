...
│
├── [[backends]]  name="amd-gateway"  endpoint="https://llm-gateway.example.com/api"
...
[[backends]]
name = "amd-gateway"
endpoint = "https://llm-gateway.example.com/api"
...
apxm backend add amd-gateway --protocol openai --endpoint https://llm-gateway.example.com/api
