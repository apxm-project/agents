...
**Component**: `vllm-graph-awareness.md`
...
│                          OPTIMIZATION LAYER                                 │
│                                                                             │
│  vLLM Graph-Aware Extensions (vllm-graph-awareness.md)    │
│  ───────────────────────────────────────────────────────────────────────    │
...
- [Metrics Infrastructure](../benchmarks/methodology/metrics-infrastructure.md) — What's tracked, how to measure
- [Compiler Methodology](../benchmarks/methodology/compiler.md) — Three-tier approach, reporting template
- [vLLM Methodology](../benchmarks/methodology/vllm.md) — Inference-time metrics, Prometheus, correlation
- [Literature Survey](../benchmarks/methodology/literature-survey.md) — 76 papers on LLM inference optimization
- [vLLM Graph Awareness](vllm-graph-awareness.md) — Phase 0-4 plan, contract, exit criteria
- [Benchmark Results](../benchmarks/results/2026-04-08.md) — Verified execution paths
...
> See also: [Vision](vision.md) for the big picture, [Opportunities](opportunities.md) for the top 5 optimization proposals, [Gap Analysis](gap-analysis.md) for detailed gap inventory, [vLLM Graph Awareness](vllm-graph-awareness.md) for Phases 0-4, [Optimization Targets](optimization-targets.md) for goal-directed compilation, [DSPy Integration](dspy-integration.md) for prompt optimization, [Implementation](../implementation/) for code-level architecture.
