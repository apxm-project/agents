...
17. APXM Documentation: [Agent Instruction Set (AIS)](ais.md) -- typed operation taxonomy and latency model.

18. APXM Documentation: [Compiler Pipeline](../implementation/compiler/overview.md) -- MLIR-based compilation and optimization passes for agentic dataflow graphs.

19. APXM Documentation: [Scheduling](scheduling.md) -- how the runtime schedules AIS operations using the dataflow firing rule.
