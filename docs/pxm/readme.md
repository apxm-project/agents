...
The theory documented here is realized in the compiler and runtime. For implementation details, see the [`../implementation/`](../implementation/) directory:

- [architecture.md](../implementation/architecture.md) -- end-to-end system architecture
- [compiler/](../implementation/compiler/) -- MLIR pipeline, [optimization passes](../optimization/passes.md), artifact format
- [runtime/](../implementation/runtime/) -- dataflow scheduler, memory hierarchy, multi-agent, [sessions](../implementation/runtime/sessions.md)
- [ais/](../implementation/ais/) -- per-category operation reference with concrete examples
- [design/](../design/) -- hierarchical AAM, agent profiles, agentic OS concepts
