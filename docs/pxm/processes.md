...
> This document covers both conceptual semantics and implementation-level behavior. For additional runtime implementation details (session storage, ACP protocol internals, capability system), see [runtime sessions](../implementation/runtime/sessions.md) and [multi-agent runtime](../implementation/runtime/multi-agent.md).
