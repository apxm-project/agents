...
> For implementation details (backing stores, concurrency mechanisms, search pipelines), see [memory hierarchy implementation](../implementation/runtime/memory-hierarchy.md).
