...
pub use operations::{
    ...
    OperationSpec, SEMANTIC_TABLEGEN_DECLARATIONS_FILE, SLOT_CAPABILITY_REF, SLOT_CARRIED,
    SLOT_INITIAL, SLOT_MODEL_REF, SLOT_OUTPUT, STRUCTURAL_OPERAND_SLOTS,
    STRUCTURAL_TABLEGEN_DECLARATIONS_FILE, SemanticOpKind, StructuralOpKind,
    WIRE_INDEXED_OPERATIONS, generate_artifact_operation_kind_cases,
