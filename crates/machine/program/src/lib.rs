...
//! schemas — `apxm.frontend-graph`, `apxm.air`, `apxm.source-map`,
//! `apxm.executable-artifact`, and `apxm.port-requirement.v1`. It provides
...
pub use artifact::{
    ...
    PortRequirement, PortSourceScope, SourceBundle, air_semantic_requirements,
