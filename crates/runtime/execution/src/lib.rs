...
pub use driver::{
    ...
    StaticHookHandlerPort, StaticHookInvocation, StaticHookResult, admit_owner_answer,
    commit_parked_admission_failure, execute, execute_resumable,
    execute_resumable_with_resource_ceilings, execute_with_resource_ceilings, parked_owner_request,
    resume, resume_invocation, resume_invocation_with_resource_ceilings,
