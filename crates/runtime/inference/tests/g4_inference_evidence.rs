...
fn usage_lineage_is_immutable_and_rejects_downstream_recompute() {
    let mut lineage = InferenceUsageLineage::seal(
        ...
        0,
        DIGEST_B,
        InferenceLineageTarget::new("model.alpha", DIGEST_C, "model-deployment.1", DIGEST_A),
        Usage {
            input_tokens: 9,
            output_tokens: 4,
        },
...
fn evidence_coordinates_are_digest_bound_and_swaps_fail() {
    let mut lineage = InferenceUsageLineage::seal(
        ...
        0,
        DIGEST_A,
        InferenceLineageTarget::new("model.alpha", DIGEST_B, "deploy.alpha", DIGEST_C),
        Usage {
            input_tokens: 2,
            output_tokens: 3,
        },
...
fn agreeing_diagnostics_remain_non_authoritative() {
    let mut lineage = InferenceUsageLineage::seal(
        ...
        0,
        DIGEST_B,
        InferenceLineageTarget::new("model.alpha", DIGEST_C, "model-deployment.2", DIGEST_A),
        Usage {
            input_tokens: 1,
            output_tokens: 1,
        },
...
fn diagnostics_reject_foreign_commit_or_unbounded_reference() {
    let mut lineage = InferenceUsageLineage::seal(
        ...
        0,
        DIGEST_B,
        InferenceLineageTarget::new("model.alpha", DIGEST_C, "model-deployment.3", DIGEST_A),
        Usage::default(),
        1,
        None,
    )
