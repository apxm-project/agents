...
mod tests {
    ...
    fn sample_air() -> serde_json::Value {
        json!({
            ...
            "semantic_operations": [
                {"node_id": "node.model.1", "op": "model.call", "parent_region_id": "region.loop.1", "execution_order": 0, "operands": [{"slot": "model_ref", "value_id": "model.default", "type_ref": "ModelTargetRef"}, {"slot": "request", "value_id": "value.loop.input", "type_ref": "ModelRequest"}], "result": {"value_id": "value.model.out", "type_ref": "ModelOutput"}},
