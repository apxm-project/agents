...
The Python frontend for [APXM](https://github.com/apxm-project/apxm),
...
runtime — install it separately and use the `dekk apxm` CLI:

```bash
dekk apxm execute path/to/workflow.py
```

See the main [APXM repo](https://github.com/apxm-project/apxm) for the
...
MIT. See [LICENSE](https://github.com/apxm-project/apxm/blob/main/LICENSE).
