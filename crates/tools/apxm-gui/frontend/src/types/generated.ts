...
export const ATTR = {
  ...
  _VLLM_PRIORITY_CLASS: "_vllm_priority_class",
  _VLLM_DOWNSTREAM_NODES: "_vllm_downstream_nodes",
  _VLLM_REUSE_GROUP: "_vllm_reuse_group",
  _VLLM_CRITICAL_PATH: "_vllm_critical_path",
  _VLLM_PIN_MODE: "_vllm_pin_mode",
  _VLLM_EST_TOKENS: "_vllm_est_tokens",
  _VLLM_WARMUP: "_vllm_warmup",
  _VLLM_PIPELINE: "_vllm_pipeline",
  MEMORY: "memory",
  BELIEFS: "beliefs",
  GOALS: "goals",
