...
const FILE_HEADER: &str = "# APXM Credentials - Managed by `apxm llm`\n\
...
pub enum CredentialError {
    ...
    #[error(
        "Credential '{name}' already exists. Remove it first with: apxm llm remove {name}"
    )]
...
impl CredentialStore {
    ...
    pub fn generate_config(&self) -> Result<String, CredentialError> {
        ...
        output.push_str("# Generated by `apxm llm generate-config`\n\n");
