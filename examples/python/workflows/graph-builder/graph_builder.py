...
def graph_builder(g: GraphRecorder):
    ...
    strategy_prompt = g.ask(
        "strategy_prompt",
        template="Build a workflow strategy analysis prompt for this goal: {0}. Ask a Workflow Strategist "
    ...
    arch_prompt = g.ask(
        "arch_prompt",
        template="Build an agent topology design prompt. Goal: {0}. Strategy: {1}. Ask an Agent Topology "
    ...
    skeptic_prompt = g.ask(
        "skeptic_prompt",
        template="Build a skeptic challenge prompt. Goal: {0}. Strategy: {1}. Topology: {2}. Ask a Workflow Skeptic "
    ...
    profiles_prompt = g.ask(
        "profiles_prompt",
        template="Build a prompt for writing focused agent context profiles. Topology: {0}. Ask for 100-200 word "
    ...
    summary = g.ask(
        "summary",
        template="Synthesize a complete actionable summary. Goal: {0}. Workflow files generated: {1}. "
