...
def coordinator_main(g: GraphRecorder):
    ...
    evaluation = g.reason("evaluation", "Critically evaluate this text for accuracy: {findings}")

    # Final summary
    summary = g.ask("summary", "Provide a final summary of the investigation based on: {evaluation}")
