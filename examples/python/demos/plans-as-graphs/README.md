...
This demo closes the user-facing half of Plan 06 (plans-as-graphs).
...
- Not the full Rust `dispatch_open_ended()` helper Plan 06 stretch B
...
- [Plan 06 — Plans as Graphs](../../../../.apxm/docs/plans/06-plans-as-graphs.md)
