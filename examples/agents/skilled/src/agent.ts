// The TypeScript twin of the Skilled reference Workflow Program.
//
// It declares the same two Workflow Skills the Python source does, in the same two
...
import { Workflow, Skill } from "@apxm/frontend";
...
type SkilledProgram = ReturnType<typeof Workflow<ReviewRequest, ReviewGuidance>>;
...
export const SkilledExample: SkilledProgram = Workflow<ReviewRequest, ReviewGuidance>({
  name: "SkilledExample",
  async run() {
