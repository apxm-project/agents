...
DOGFOOD_TASKS: tuple[str, ...] = (
    ...
    "Create an APXM plan to review sandbox preflight handling for generated INV_TOOL nodes.",
    "Create an APXM plan to inspect trace_id validation and summarize path traversal risk.",
    "Create an APXM plan to review skill:// resource resolution for traversal and duplicate-id behavior.",
    "Create an APXM plan to audit startup runtime setup for model-router initialization risk.",
    ...
    "Create an APXM plan to review capability_list output and summarize model-router health visibility.",
    "Create an APXM plan to inspect evidence_lookup allowed roots and summarize evidence exposure risk.",
    "Create an APXM plan to review aam_recall output size controls and summarize context-bloat risk.",
    "Create an APXM plan to inspect trace_fetch summary/full behavior and summarize default safety.",
    "Create an APXM plan to review release build readiness for apxm-mcp-server across Claude and Codex.",
    "Create an APXM plan to inspect generated docs for remaining placeholders before commit.",
    "Create an APXM plan to summarize final ship readiness, residual risks, and verification steps.",
)
