...
mkdir -p "$OUT_DIR"
SVC_STATE="/home/raherrer/projects/apxm/.apxm/vllm-services/vllm-gptoss.json"
LOG_PAT="/home/raherrer/projects/apxm/.apxm/vllm-logs/slurm-apxm-vllm-service-vllm-gptoss-%j.out"
...
bring_up_service_wait_ready() {
  ...
  local log="/home/raherrer/projects/apxm/.apxm/vllm-logs/slurm-apxm-vllm-service-vllm-gptoss-${jid}.out"
  local waited=0
  local max_wait=900
  while [ ! -f "$log" ]; do
