...
class AgentsReleaseManifestTests(unittest.TestCase):
    ...
    def test_committed_owner_cohort_is_exact(self) -> None:
        ...
        self.assertEqual(
            ...
            "fe3d36c053ec144e3ede610df855d931ca4279b4",
        )
        self.assertEqual(
    ...
    def test_runtime_or_distribution_claims_are_not_in_cohort(self) -> None:
        encoded = json.dumps(self.manifest, sort_keys=True).lower()
        for term in ("image", "live", "signature", "trust root", "pki"):
    ...
    def test_evidence_is_derived_from_the_manifest(self) -> None:
        ...
        self.assertEqual(
            evidence["verification"]["runtime_execution"], "not_attested"
        )
