...
class MetricsKeys:
    ...
    SECTION_COMPILER: Final[str] = "compiler"
    SECTION_RUNTIME: Final[str] = "runtime"
    SECTION_BACKENDS: Final[str] = "backends"
    RUNTIME_EXECUTION: Final[str] = "execution"
    ...
    COMPILER_PASSES: Final[str] = "passes"
    COMPILER_SUMMARY: Final[str] = "summary"
    SUMMARY_TOTAL_PASSES: Final[str] = "total_passes"
    SUMMARY_INITIAL_OPS: Final[str] = "initial_ops"
    SUMMARY_FINAL_OPS: Final[str] = "final_ops"
    SUMMARY_TOTAL_OPS_ELIMINATED: Final[str] = "total_ops_eliminated"
    SUMMARY_TOTAL_TOKENS_SAVED: Final[str] = "total_tokens_saved"
    SUMMARY_FIRED_PASSES: Final[str] = "fired_passes"
    SUMMARY_ACTIVE_PASSES: Final[str] = "active_passes"
