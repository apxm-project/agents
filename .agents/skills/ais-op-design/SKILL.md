...
- Anything that would change `dekk agents ops list` output.
...
- the Python frontend bindings (via `dekk agents codegen`).
...
4. `crates/runtime/runtime/src/executor/handlers/<op>.rs` (+ `pub mod`
